...
export const GithubRepoCard = ({ repo }: Props) => {
  ...
  return (
    <a
      href={repo.html_url}
      target="_blank"
      className="flex h-[150px] w-[350px] flex-col gap-2 overflow-x-auto rounded-lg bg-zinc-800/50 p-4 shadow-glass backdrop-blur-lg transition hover:bg-zinc-800"
      rel="noreferrer"
    >
      ...
      <div className="flex items-center gap-2">
        <div className={`h-2 w-2 rounded-full ${test}`} />
